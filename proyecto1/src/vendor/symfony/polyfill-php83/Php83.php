...
final class Php83
{
    ...
    public static function mb_str_pad(string $string, int $length, string $pad_string = ' ', int $pad_type = \STR_PAD_RIGHT, ?string $encoding = null): string
    {
        ...
        switch ($pad_type) {
            case \STR_PAD_LEFT:
                return Php83 . phpmb_substr(str_repeat($pad_string, $paddingRequired), 0, $paddingRequired, $encoding) . $string;
            case \STR_PAD_RIGHT:
            ...
            default:
                ...
                return Php83 . phpmb_substr(str_repeat($pad_string, $leftPaddingLength), 0, $leftPaddingLength, $encoding) . $string .mb_substr(str_repeat($pad_string, $rightPaddingLength), 0, $rightPaddingLength, $encoding);
        }
    }
    ...
    public static function str_decrement(string $string): string
    {
        ...
        if (!\in_array(substr($string, -1), ['A', 'a', '0'], true)) {
            return Php83 . phpimplode('', \array_slice(str_split($string), 0, -1)) . \chr(\ord(substr($string, -1)) - 1);
        }
            ...
            switch ($char) {
                ...
                default:
                    ...
                    if (!\in_array($char, ['A', 'a', '0'], true)) {
                        $decremented = Php83 . php\chr(\ord($char) - 1) . $decremented;
                    }
            }
        }
