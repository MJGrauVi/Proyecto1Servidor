...
<head>
    ...
    <link rel="stylesheet" href="<?=DIRECTORIO_CSS_FRONTEND?>landing.css">
    <link rel="stylesheet" href="<?=DIRECTORIO_CSS_FRONTEND?>responsive.css">
...
<div style="position: relative;">
            ...
            <div class="netflix-row">
                <div class="left d-flex align-items-center">
                    ...
                    <div  class="netflix-nav">
                        <section>
                            <button type="button" onclick="window.location.replace('/')">Home</button>
    ...
    <div class="">
        <section class="netflix-home-video">
            ...
            <video src="<?=DIRECTORIO_VIDEO_FRONTEND?>video.mp4" autoplay muted loop></video>
            <div class="content">
                <section class="left">
                    <img src="<?=DIRECTORIO_IMG_FRONTEND?>image2.webp" alt="">
                ...
                <div class="carousel-inner" style="position: relative; overflow: visible;">
                    <div class="carousel-item active">
                        <section class="d-flex" style="">
                            <div class="card" >
                                <img src="<?=DIRECTORIO_IMG_FRONTEND?>trending/img6.jpeg" class="card-img-top" alt="...">
                                <div class="card-body">
                            ...
                            <div class="card">
                                <img src=".<?=DIRECTORIO_IMG_FRONTEND?>trending/img2.jpeg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <section class="d-flex justify-content-between">
                                        <div>
                                            <i class="bi bi-play-circle-fill card-icon"  ></i>
                            ...
                            <div class="card">
                                <img src="<?=DIRECTORIO_IMG_FRONTEND?>trending/img3.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <section class="d-flex justify-content-between">
                                        <div>
                                            <i class="bi bi-play-circle-fill card-icon"  ></i>
                            ...
                            <div class="card" >
                                <img src="<?=DIRECTORIO_IMG_FRONTEND?>trending/img4.jpeg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <section class="d-flex justify-content-between">
                                        <div>
                                            <i class="bi bi-play-circle-fill card-icon"  ></i>
                            ...
                            <div class="card" >
                                <img src="<?=DIRECTORIO_IMG_FRONTEND?>trending/img1.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <section class="d-flex justify-content-between">
                                        <div>
                                            <i class="bi bi-play-circle-fill card-icon"  ></i>
                    ...
                    <div class="carousel-item">
                        <section class="d-flex" >
                            <div class="card" >
                                <img src="<?=DIRECTORIO_IMG_FRONTEND?>trending/img7.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <section class="d-flex justify-content-between">
                                        <div>
                                            <i class="bi bi-play-circle-fill card-icon"  ></i>
...
<script src="<?=DIRECTORIO_JS_FRONTEND?>javaScript.js"></script>
</body>
</html>