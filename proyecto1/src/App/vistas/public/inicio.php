<?php
   $titulo = "Inicio";
    ...
    include "App/vistas/public/template/head.php";
    include "App/vistas/public/template/header.php";
    include "App/vistas/public/template/aside.php"; ?>
<main class="content">
...
<?php
include_once "App/vistas/public/template/footer.php";